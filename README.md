...
The default address of the OAuth2 authentication server is `https://localhost:9000`, but it can be changed in the `application.properties` file or by using environment variables.
